...
|----------|------|-------------|
| `allWeapons` | `[WeaponEntry](./WeaponManager.WeaponEntry.md)[]` | All weapons loaded into the game. |
...
[return: [WeaponEntry](./WeaponManager.WeaponEntry.md)]
...
| Parameter | Type | Description |
|-----------|------|-------------|
| `entry` | `[WeaponEntry](./WeaponManager.WeaponEntry.md)` | The weapon entry to check. |
