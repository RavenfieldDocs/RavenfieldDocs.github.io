...
| --- | --- | --- |
| capturePoint | CapturePoint | The capture point that was captured. |
| newOwner | Team | The new owner of the capture point. |
...
| Parameter | Type | Description |
| --- | --- | --- |
| capturePoint | CapturePoint | The capture point that was neutralized. |
| previousOwner | Team | The previous owner of the capture point. |
